...
export default function LoadingScreen({ onDone }) {
  return (
    ...
    >
      ...
      >
        <div className="mx-auto grid h-14 w-14 place-items-center rounded-2xl bg-white/8 shadow-glow ring-1 ring-white/10">
          <span className="bg-gradient-to-br from-indigo-300 via-fuchsia-200 to-cyan-200 bg-clip-text text-xl font-semibold text-transparent">
            A
          </span>
        </div>
        <p className="mt-5 text-sm text-zinc-300">Loading experience…</p>
